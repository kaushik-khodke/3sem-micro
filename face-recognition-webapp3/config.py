...
# Base directory of this config file (used to resolve relative paths)
_BASE_DIR = _os.path.dirname(_os.path.abspath(__file__))

# Camera configuration
CAMERA_SOURCE = _os.path.join(_BASE_DIR, "assets", "test.mp4")
SHOW_FPS = True
...
MODEL_PATH = _os.path.join(_BASE_DIR, "yolov8n-pose.pt")  # pose model — gives keypoints for accurate conflict detection
...
WEAPON_IMG_SIZE = 640  # higher resolution for weapon/object detection (small objects need more pixels)
...
# Weapon / dangerous object detection (COCO class IDs)
KNIFE = 43
SCISSORS = 76
BASEBALL_BAT = 34
BOTTLE = 39
WEAPON_CLASSES = [KNIFE, SCISSORS, BASEBALL_BAT]
DANGEROUS_OBJECTS = WEAPON_CLASSES + [BOTTLE]  # bottle can look like a weapon

# Second model for general object detection (auto-downloads ~6MB)
# yolov8s = 'small' model — 2x more accurate than nano for object detection
...
ENABLE_BEEP = False
ALERT_SOUND_PATH = _os.path.join(_BASE_DIR, "assets", "alert.mp3")
AUDIO_VOLUME = 0.8
